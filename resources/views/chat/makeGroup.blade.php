...
<div class="container">
    ...
    <div class="py-5 text-center">
        <h1 class="card-header text-white bg-primary">グループを作成しよう!</h1>
    </div>
            ...
            <form action="{{ route('chat.confirm') }}" method="POST" class="form-horizontal">
                ...
                <div class="input-group mb-4">
                    <div class="input-group-prepend col-3 px-0">
                        <label class="input-group-text col-12" for="name">グループ名</label>
                    </div>
                    <input type="text" name="name" class="form-control col-9 {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" value="{{ old('name') }}" autofocus required placeholder='グループ名'>
                </div>
                ...
                <div class="input-group mb-5">
                    <div class="input-group-prepend col-3 px-0">
                        <label class="input-group-text col-12" for="intro">グループ紹介文</label>
                    </div>
